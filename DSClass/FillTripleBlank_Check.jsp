...
<html:html locale="true">
  ...
  <body bgcolor="white"><p>   
   ...
   <html:errors/><p> 
    ...
    <logic:present name="filltripleblankbean" scope="request">
       <h1>
         <bean:message key="hello.jsp.page.solution"/>
         <bean:write name="filltripleblankbean" property="statement_1st" />         
         <bean:write name="filltripleblankbean" property="solution_1st" />    
         <bean:write name="filltripleblankbean" property="statement_2nd" />
         <bean:write name="filltripleblankbean" property="solution_2nd" />    
         <bean:write name="filltripleblankbean" property="statement_3rd" />
         <bean:write name="filltripleblankbean" property="solution_3rd" />    
         <bean:write name="filltripleblankbean" property="statement_4th" />
<br>
         <bean:write name="filltripleblankbean" property="explanation" /><P> 
       </h1>
    </logic:present>
  ...
  <!--   <bean:message key="hello.jsp.page.lastCorrect"/>
    ...
    <% session = request.getSession(true);     
       ...
       session.setAttribute(hello.Constants.FILLTRIPLEBLANK_KEY, _ftbb);
    ...
    <% if (id == 122) { %>
        <html:img page="/pic/b6_ch5_tb_122e.png" alt="Powered by Struts"/>
    <% } else if (id == 194) { %>
        <html:img page="/pic/b6_ch6_11_tb_194e.png" alt="Powered by Struts"/>
    <% } else if (id == 195) { %>
        <html:img page="/pic/b6_ch6_12_tb_195_3e.png" alt="Powered by Struts"/>
    <% } else if (id == 207) { %>
        <html:img page="/pic/b6_ch6_class8_tb_207e.png" alt="Powered by Struts"/>
    <% } %>
