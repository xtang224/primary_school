...
public class DrawLineApplet96 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine96());
     
   }  
}

class DrawLine96 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterC2 = xcenterB2 + 3*30;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请按照1：2的比例把三角形A缩小为A2，请点击选择和A2在同一竖直线上的另外一个顶点,你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了1：2缩小的三角形的一个顶点";
              comment2 = "请继续找图中1：2缩小的三角形的另外一个顶点,你画了" + (clickCount+1) + "次;";
           }else{
        ...
        comment = "图中给出了三角形A和其按比例1：2缩小的三角形A2的1个顶点，请完成这个三角形。";   
        comment2 = "请点击选择和A2在同一竖直线上的另外一个顶点。";     
     }
