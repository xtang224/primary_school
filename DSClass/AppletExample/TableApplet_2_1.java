...
public class TableApplet_2_1 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_1());
   }
}

class TablePanel_2_1 extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          ...
          Integer busValue = (Integer)myTable.getValueAt(2,1);
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"因数",
                                        "因数",
                                        "积"};
        private Object[][] data = {
	    {new Integer(45), new Integer(23), new Integer(-1)},
	    {new Integer(-1), new Integer(32), new Integer(480)},
            {new Integer(16), new Integer(-1), new Integer(64)}	    
        };
