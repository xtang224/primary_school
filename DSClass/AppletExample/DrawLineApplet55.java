...
public class DrawLineApplet55 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine55());
     
   }  
}

class DrawLine55 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (clickCount>=0){
        ...
        comment = "图中给出了从左面看物体的一个正方形，请依次在点A的左侧和右侧找到相应的顶点，画出其余的图形。";        
     }
