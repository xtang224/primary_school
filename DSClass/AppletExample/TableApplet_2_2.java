...
public class TableApplet_2_2 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_2());
   }
}

class TablePanel_2_2 extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"被除数",
                                        ...
                                        "商"};
        private Object[][] data = {
	    {new Integer(84), new Integer(-1), new Integer(12)},
	    {new Integer(-1), new Integer(24), new Integer(52)},
            {new Integer(532), new Integer(28), new Integer(-1)}	    
        };
