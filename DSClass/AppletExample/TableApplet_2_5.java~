...
public class TableApplet_2_5 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_5());
   }
}

class TablePanel_2_5 extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          Integer carValue = (Integer)myTable.getValueAt(0,1);
          Integer truckValue = (Integer)myTable.getValueAt(1,0);
          Integer busValue = (Integer)myTable.getValueAt(2,2);
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"被除数",
                                        "除数",
                                        "商"};
        private Object[][] data = {
	    {new Integer(68), new Integer(-1), new Integer(34)},
	    {new Integer(-1), new Integer(32), new Integer(18)},
            {new Integer(288), new Integer(48), new Integer(-1)}	    
        };
