...
class DrawLine127 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请点击选择点A绕点O按顺时针方向旋转90度后到达的点,你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了点A绕点O按顺时针方向旋转90度后到达的点";
              comment2 = "请继续找点B绕点O按顺时针方向旋转90度后到达的点,你画了" + (clickCount+1) + "次;";
           }else{
              if (done3==false){
                 comment = "你已经找到了点A，B绕点O按顺时针方向旋转90度后到达的点";
                 comment2 = "请继续找点C绕点O按顺时针方向旋转90度后到达的点,你画了" + (clickCount+1) + "次;";
              }else{
                 if (done4==false){
                    comment = "你已经找到了点A，B，C绕点O按顺时针方向旋转90度后到达的点";
                    comment2 = "请继续找点D绕点O按顺时针方向旋转90度后到达的点,你画了" + (clickCount+1) + "次;";
                 }else{
                    if (done5==false){
                       comment = "你已经找到了点A，B，C，D绕点O按顺时针方向旋转90度后到达的点";
                       comment2 = "请继续找点O向右平移5格后的点,你画了" + (clickCount+1) + "次;";                       
                    }else{
                       if (done6==false){
                          comment = "你已经找到了点O向右平移5格后的点";                          
                          comment2 = "请继续找点A旋转后到达的点向右平移5格后的点,你画了" + (clickCount+1) + "次;";
                       }else{
                          if (done7==false){
                             comment = "你已经找到了点A旋转后到达的点向右平移5格后的点";                          
                             comment2 = "请继续找点B旋转后到达的点向右平移5格后的点,你画了" + (clickCount+1) + "次;";
                          }else{
                             if (done8==false){
                                comment = "你已经找到了点B旋转后到达的点向右平移5格后的点";                          
                                comment2 = "请继续找点C旋转后到达的点向右平移5格后的点,你画了" + (clickCount+1) + "次;";
                             }else{
                                if (done9==false){
                                   comment = "你已经找到了点C旋转后到达的点向右平移5格后的点";                          
                                   comment2 = "请继续找点D旋转后到达的点向右平移5格后的点,你画了" + (clickCount+1) + "次;";
                                }else{
        ...
        comment = "图中给出了多边形OABCD，请完成这个图形绕O点按顺时针方向旋转90度后的图形。";   
       comment2 = "再将旋转后的图形向右平移5格。";     
     }
