...
public class DrawLineApplet53 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine53());
     
   }  
}

class DrawLine53 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (clickCount>=0){
        ...
        comment = "图中给出了从前面看的一个正方形，请在点A的左侧找到相应的顶点，画出其余的图形。";        
     }
