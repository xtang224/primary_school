...
public class TableApplet15 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table15Panel());
   }
}

class Table15Panel extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"", "实验小学", "阳光小学（填名次）", "本场胜者（填学校）"};
        private Object[][] data = {           
            {"第一场", "第一名", "X", "X"},
            {"第二场", "第二名", "X", "X"}, 
            {"第三场", "第三名", "X", "X"} 
