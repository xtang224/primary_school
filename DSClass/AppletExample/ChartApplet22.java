...
public class ChartApplet22 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine22());
     
   }  
}

class ChartLine22 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 500-400; // Center position of A
  private static int xcenterB = 220;
  private static int ycenterB = 500-320; // Center position of B
  private static int xcenterC = 300;
  private static int ycenterC = 500-360; // Center position of C  
  private static int xcenterD = 380;
  private static int ycenterD = 500-160; // Center position of D
  private static int xcenterE = 460;
  private static int ycenterE = 500-200; // Center position of E
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("四（5）班同学吃早餐情况统计图", 150, 50);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA, ycenterA, 40, 400);              
        }else{
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 160);            
        }else{
        ...
        if (done5){
           g2d.fillRect(xcenterE, ycenterE, 40, 200);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出四（5）班早餐10人吃米粉的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四（5）班早餐吃米粉的柱状图，请继续8人早餐吃包子的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四（5）班早餐吃米粉、吃包子的柱状图，请继续画9人早餐吃粥的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了四（5）班早餐吃米粉、吃包子、吃粥的柱状图，请继续画4人早餐吃馒头的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    if (done5==false){
                       comment = "你已经画出了四（5）班早餐吃米粉、吃包子、吃粥、吃馒头的柱状图，请继续画5人早餐不吃的柱状图。你画了" + (clickCount+1) + "次";
                    }else{
                       drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示画出四（5）班同学吃早餐情况统计图。";
        comment2 = "即画出10人吃米粉、8人吃包子、9人吃粥、4人吃馒头和5人不吃的条形统计图。"; 
     }
