...
public class ChartApplet3 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine3());
     
   }  
}

class ChartLine3 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterD = 200; // Center position of D
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done2){
           g2d.fillRect(xcenterB, ycenterB, 40, 200);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请根据要求先画出四（1）班9月得12面红旗的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四（1）班9月得红旗的柱状图，请继续画四（1）班10月得10面红旗的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四（1）班9月,10月得红旗的柱状图，请继续画四（1）班11月得14面红旗的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4 == false){
                    comment = "你已经画出了四（1）班9月,10月，11月得红旗的柱状图，请继续画四（1）班12月得15面红旗的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出四（1）班9，10，11，12月得红旗的柱状图。";
        comment2 = "即画出9月得12面、10月得10面、11月得14面和12月得15面的条形统计图。"; 
     }
