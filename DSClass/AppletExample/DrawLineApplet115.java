...
public class DrawLineApplet115 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine115());
     
   }  
}

class DrawLine115 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     if (clickCount>=0){
        ...
        gp = new GeneralPath();
        if (done1){             
           g2d.fillArc(xcenterO2-90, ycenterO2-90, 180, 180, 0, 360);  
           g2d.setPaint(Color.white);
           g2d.fillArc(xcenterO2-60, ycenterO2-60, 120, 120, 0, 360);                               
        }else{
           if (aroundPoint2(startX,startY,xcenterO2,ycenterO2,90)){
              done1 = true;   
              drawCorrect = true;           
              g2d.fillArc(xcenterO2-90, ycenterO2-90, 180, 180, 0, 360);      
              g2d.setPaint(Color.white);
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请在图中画出一个同心圆，使其半径比已知圆扩大1.5倍。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
        ...
        comment = "如图，图中给出了一个圆，请在图中画出一个同心圆，使其半径扩大1.5倍。";   
        comment2 = "";     
     }
