...
public class TableApplet_2_3 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_3());
   }
}

class TablePanel_2_3 extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        ...
        private Object[][] data = {
	    {new String("数量/千克"), new Integer(3), new Integer(-1), new Integer(15), new Integer(-1)},
	    {new String("总价/元"), new Integer(-1), new Integer(165), new Integer(-1), new Integer(315)}
        };
