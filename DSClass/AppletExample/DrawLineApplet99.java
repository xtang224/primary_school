...
public class DrawLineApplet99 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine99());
     
   }  
}

class DrawLine99 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterO = 260; // Center position of O
