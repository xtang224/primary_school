...
public class DrawLineApplet117 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine117());
     
   }  
}

class DrawLine117 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = xcenterO2 - 53;
  private static int ycenterA = ycenterO2 - 53; // Center position of A
  private static int xcenterB = xcenterO2 + 63;
  private static int ycenterB = ycenterO2; // Center position of B
  private static int xcenterC = xcenterO2 + 53;
  private static int ycenterC = ycenterO2 - 53; // Center position of C  
  ...
  public void drawArc(Graphics2D g2d){
     ...
     g2d.drawString("小敏家", xcenterA-10, ycenterA-10); 
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){             
           ...
           g2d.drawString("青少年活动中心", xcenterC-10, ycenterC+10); 
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,青少年活动中心距离学校有500米，位置在学校的东北方向，请点击选择青少年活动中心所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
        ...
        comment = "如图，在图中标出青少年活动中心的位置。";   
        comment2 = "青少年活动中心距离学校有500米，位置在学校的东北方向，请点击选择青少年活动中心所对应的点。";     
     }
  ...
  public void drawRatio(Graphics2D g2d){
     ...
     g2d.drawString("200m", 60, 360); 
     g2d.drawString("比例尺1：20000", 60, 460); 
     g2d.draw(gp); 
  } 
