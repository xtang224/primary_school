...
public class DrawLineApplet61 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine61());
     
   }  
}

class DrawLine61 extends JPanel implements MouseListener, ActionListener
{
     ...
     if (clickCount>=0){
        if (done1==false){            
           ...
           if (done2==false)
              ...
              if (done3==false)
                 comment = "你已经在点A的左侧和右侧画对,请在点A的左侧下方找到另外一个正方形的顶点,你画了" + (clickCount+1) + "次;";
              else{
        ...
        comment = "图中给出了看物体的一个正方形，请依次在点A的左侧,右侧,左侧下方找到相应的顶点，画出其余的图形。";        
     }
