...
public class TableApplet6 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table6Panel());
   }
}

class Table6Panel extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          Integer class1Value = (Integer)myTable.getValueAt(0,2);
          Integer class2Value = (Integer)myTable.getValueAt(1,3);
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"", "自行车", "汽车", "火车"};
        private Object[][] data = {	    
            {"路程/千米", new Integer(60), new Integer(-1), new Integer(600)},
	    {"时间/时", new Integer(4), new Integer(9), new Integer(-1)},
            {"速度（千米/时）", new Integer(-1), new Integer(60), new Integer(200)}
        };
