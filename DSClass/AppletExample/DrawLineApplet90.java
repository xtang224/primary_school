...
public class DrawLineApplet90 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine90());
     
   }  
}

class DrawLine90 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterO = 150-45*3;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){          
           g2d.fillArc(xcenterO-5, ycenterO-5, 10, 10, 0, 360);      
           g2d.drawString("-4.5", xcenterO-5, ycenterO-10);                   
        }else{
        ...
        if (done2){          
           g2d.fillArc(xcenterA-5, ycenterA-5, 10, 10, 0, 360);      
           g2d.drawString("+3", xcenterA-10, ycenterA-10);                   
        }else{
        ...
        if (done3){          
           g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);      
           g2d.drawString("+1.5", xcenterB-10, ycenterB-10);                   
        }else{
        ...
        if (done4){          
           g2d.fillArc(xcenterC-5, ycenterC-5, 10, 10, 0, 360);      
           g2d.drawString("-5/2", xcenterC-10, ycenterC-10);                   
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请在数轴上表示-4.5,你画了" + (clickCount+1) + "次;";                   
        }else{
           if (done2==false){          
              comment = "你已经在数轴上表示-4.5，请继续在数轴上表示+3，你画了" + (clickCount+1) + "次;"; 
           }else{                
              if (done3==false){                 
                 comment = "你已经在数轴上表示-4.5,+3，请继续在数轴上表示1.5，你画了" + (clickCount+1) + "次;"; 
              }else{
                 if (done4==false){
                    comment = "你已经在数轴上表示-4.5,+3,1.5，请继续在数轴上表示-5/2，你画了" + (clickCount+1) + "次;";
                 }else{
        ...
        comment = "图中给出了一个数轴，在数轴上依次表示各数：-4.5，+3，1.5，-5/2;";             
     }
