...
public class ChartApplet23 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine23());
     
   }  
}

class ChartLine23 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 500-360; // Center position of A
  private static int xcenterB = 220;
  private static int ycenterB = 500-300; // Center position of B
  private static int xcenterC = 300;
  private static int ycenterC = 500-400; // Center position of C  
  private static int xcenterD = 380;
  private static int ycenterD = 500-260; // Center position of D
  private static int xcenterE = 460;
  private static int ycenterE = 500-140; // Center position of E
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("四年级同学吃早餐情况统计图", 150, 50);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA, ycenterA, 40, 360);              
        }else{
        ...
        if (done2){
           g2d.fillRect(xcenterB, ycenterB, 40, 300);            
        }else{
        ...
        if (done3){
           g2d.fillRect(xcenterC, ycenterC, 40, 400);         
        }else{
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 260);            
        }else{
        ...
        if (done5){
           g2d.fillRect(xcenterE, ycenterE, 40, 140);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出四年级早餐18人吃米粉的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四年级早餐吃米粉的柱状图，请继续画15人早餐吃包子的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四年级早餐吃米粉、吃包子的柱状图，请继续画20人早餐吃粥的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了四年级早餐吃米粉、吃包子、吃粥的柱状图，请继续画13人早餐吃馒头的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    if (done5==false){
                       comment = "你已经画出了四年级早餐吃米粉、吃包子、吃粥、吃馒头的柱状图，请继续画7人早餐不吃的柱状图。你画了" + (clickCount+1) + "次";
                    }else{
                       drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示画出四年级同学吃早餐情况统计图。";
        comment2 = "即画出18人吃米粉、15人吃包子、20人吃粥、13人吃馒头和7人不吃的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","米","","包","","粥","","馒","","不",""};
     String[] strs2 = new String[]{"","粉","","子","","","","头","","吃",""};
