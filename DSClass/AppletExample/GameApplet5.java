...
public class GameApplet5 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Game5Panel());
   }
}

class Game5Panel extends JPanel
...
{  
    ...
    private String problemHint = "你和对手轮流报数，每次只能报1或2，把两人报的所有数加起来，谁报数后和是10，谁就获胜";
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals("点击此按钮提交你的对策")){
          ...
          if (gameSum < gameCritical){
             ...
             label2.setText("游戏结束，所有的数加起来的和不能超过10。请点击最下面一个按钮完成这道题。");
             done = true;
             win = false;
             myTable.setValueAt(new String("对手"),3,3);    
             return; 
