...
public class TableApplet_2_9 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_9());
   }
}

class TablePanel_2_9 extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"产品名称", "一月", "二月", "三月", "合计"};
        private Object[][] data = {
	    {new String("彩电/台"), new Integer(385), new Integer(415), new Integer(537), new Integer(-1)},
	    {new String("冰箱/台"), new Integer(248), new Integer(309), new Integer(291), new Integer(-1)},
            {new String("洗衣机/台"), new Integer(347), new Integer(418), new Integer(353), new Integer(-1)}           
        };
