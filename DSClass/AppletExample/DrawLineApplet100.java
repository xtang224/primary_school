...
public class DrawLineApplet100 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine100());
     
   }  
}

class DrawLine100 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = xcenterO+6*30;
  ...
  private static int xcenterC = xcenterO;
  private static int ycenterC = ycenterO-7*30; // Center position of C  
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     if (clickCount>=0){
        ...
        if (done3){             
           g2d.fillArc(xcenterC-5, ycenterC-5, 10, 10, 0, 360);      
           g2d.drawString("点将台", xcenterC-10, ycenterC+10);                                 
        }else{
        ...
        if (done4){             
           g2d.fillArc(xcenterD-5, ycenterD-5, 10, 10, 0, 360);      
           g2d.drawString("吴王宫", xcenterD-10, ycenterD+10);                               
        }else{
        ...
        if (done5){             
           ...
           g2d.drawString("曹营", xcenterE-10, ycenterE+10);                               
        }else{
        ...
        if (done6){             
           ...
           g2d.drawString("竞技场", xcenterF-10, ycenterF+10);                               
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,大门位于（6，0），请点击选择大门所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了大门所对应的点。大门向北走400m是八方亭，";
              comment2 = "请继续找八方亭所对应的点,你画了" + (clickCount+1) + "次;";
           }else{
              if (done3==false){
                 comment = "你已经找到了大门，八方亭所对应的点，点将台位于（0，7）";
                 comment2 = "请继续找点将台所对应的对称轴上的点,你画了" + (clickCount+1) + "次;";
              }else{
                 if (done4==false){
                    comment = "你已经找到了大门，八方亭，点将台所对应的对称轴上的点。";
                    comment2 = "点将台向东走500米是吴王宫，请继续找吴王宫所对应的点,你画了" + (clickCount+1) + "次;";
                 }else{
                    if (done5==false){
                       comment = "你已经找到了大门，八方亭，点将台，吴王宫所对应的对称轴上的点。";
                       comment2 = "曹营位于（3，3），请继续找曹营所对应的点,你画了" + (clickCount+1) + "次;";
                    }else{
                       if (done6==false){
                          comment = "你已经找到了大门，八方亭，点将台，吴王宫，曹营所对应的对称轴上的点。";
                          comment2 = "竞技场位于（3，5），请继续找竞技场所对应的点,你画了" + (clickCount+1) + "次;";
                       }else{
        ...
        comment = "如图，在三国城示意图上标出大门和一些景点的位置。";   
        comment2 = "大门位于（6，0），请点击选择大门所对应的点。";     
     }
