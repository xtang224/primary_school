...
public class DrawLineApplet121 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine121());
     
   }  
}

class DrawLine121 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = ycenterO2 - 104; // Center position of A
  private static int xcenterB = xcenterO2 + 104;
  private static int ycenterB = ycenterO2 - 2*30; // Center position of B
  private static int xcenterC = xcenterO2 + 135;
  private static int ycenterC = ycenterO2; // Center position of C  
  private static int xcenterD = xcenterO2;
  private static int ycenterD = ycenterO2 + 30; // Center position of D 
  ...
  public void drawArc(Graphics2D g2d){
     ...
     g2d.drawString("小红家", xcenterO2+10, ycenterO2-10); 

     g2d.fillArc(xcenterA-5, ycenterA-5, 10, 10, 0, 360);      
     g2d.drawString("学校", xcenterA+10, ycenterA-10); 
     
     g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);      
     g2d.drawString("商店", xcenterB-10, ycenterB-10); 

     g2d.fillArc(xcenterC-5, ycenterC-5, 10, 10, 0, 360);      
     g2d.drawString("体育馆", xcenterC-10, ycenterC-10); 
     /*
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){             
           g2d.fillArc(xcenterD-5, ycenterD-5, 10, 10, 0, 360);      
           g2d.drawString("图书馆", xcenterD-10, ycenterD-10); 
           //g2d.drawString("60度", xcenterO2-30, ycenterO2-20); 
           gp.moveTo(xcenterO2,ycenterO2);
           gp.lineTo(xcenterD,ycenterD);                                
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,图书馆在小红家正南方向300m处，请点击选择图书馆所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
        ...
        comment = "如图，在图中标出图书馆的位置。";   
        comment2 = "图书馆在小红家正南方向300m处，请点击选择图书馆所对应的点。";     
     }
