...
public class DrawLineApplet52 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine52());     
   }  
}

class DrawLine52 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = 0+50;
  private static int ycenterA = 250; // Center position of A
  private static int xcenterB = 400+50;
  private static int ycenterB = 200; // Center position of B
  private static int xcenterC = 0+50;
  private static int ycenterC = 200; // Center position of C  
  private static int xcenterD = 400+50;
  private static int ycenterD = 250; // Center position of D
  private static int xcenterO = 200+50;
  private static int ycenterO = 300; // Center position of O
  private static int xcenterO2 = 191+50;
  private static int ycenterO2 = 226;
  private static int xcenterO3 = 209+50;
  private static int ycenterO3 = 226; 
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先作通过点O垂直于AB的垂线,你画了" + (clickCount+1) + "次;"; 
        }else{
           if (done2==false){
              comment = "你已经过点O作了AB的垂线,请继续作通过点O垂直于CD的垂线，你画了" + (clickCount+1) + "次;";
           }else{                                    
              drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请先画通过点O垂直于AB的垂线；";
        comment2 = "再画通过点O垂直于CD的垂线。"; 
     }
