...
public class TableApplet16 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table16Panel());
   }
}

class Table16Panel extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          ...
          String class7Value = (String)myTable.getValueAt(3,2);
          String class8Value = (String)myTable.getValueAt(3,3);
          String class9Value = (String)myTable.getValueAt(4,2);
          String class10Value = (String)myTable.getValueAt(4,3); 
                   ...
                   if (!class4Value.equals("X")){
                      ...
                      if (!class5Value.equals("X")){
                         ...
                         if (!class6Value.equals("X")){
                            done6 =true;
                            if (!class7Value.equals("X")){
                               done7 =true;
                               if (!class8Value.equals("X")){ 
                                  done8 = true;
                                  if (!class9Value.equals("X")){
                                     done9 = true; 
                                     if (!class10Value.equals("X")){  
                                        done10 = true;  
          ...
          if (done){
             try{       
                connect();    
                target = "Table"+";"+class1Value+";"+class2Value+";"+class3Value+";"+class4Value+";"+class5Value+";"+class6Value+";"+class7Value+";"+class8Value+";"+class9Value+";"+class10Value;
                /*                    
                ptmt = dbCon.prepareStatement("select term2 from hintMatch where term1=?");
                ptmt.clearParameters();
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"", "四（2）班", "四（1）班（填名次）", "本场胜者（填班级）"};
        private Object[][] data = {           
            {"第一场", "第一名", "X", "X"},
            {"第二场", "第二名", "X", "X"}, 
            {"第三场", "第三名", "X", "X"},
