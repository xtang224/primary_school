...
public class DrawLineApplet15 extends JApplet{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine15());     
   }  
}

class DrawLine15 extends JPanel implements MouseListener, ActionListener
{
