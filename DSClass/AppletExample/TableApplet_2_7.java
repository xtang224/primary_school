...
public class TableApplet_2_7 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_7());
   }
}

class TablePanel_2_7 extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"年级", "（1）班", "（2）班", "（3）班", "合计"};
        private Object[][] data = {
	    {new String("四年级"), new Integer(44), new Integer(49), new Integer(51), new Integer(-1)},
	    {new String("五年级"), new Integer(48), new Integer(52), new Integer(46), new Integer(-1)},
            {new String("六年级"), new Integer(51), new Integer(48), new Integer(49), new Integer(-1)} 
        };
