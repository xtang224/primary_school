...
public class ChartApplet24 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine24());
     
   }  
}

class ChartLine24 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterC = 500-320; // Center position of C  
  private static int xcenterD = 380;
  private static int ycenterD = 500-300; // Center position of D
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("实验小学四年级课外兴趣小组统计图", 150, 50);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 300);            
        }else{
        ...
        if (done5){
           g2d.fillRect(xcenterE, ycenterE, 40, 80);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出四年级数学组12人的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四年级数学组的柱状图，请继续画8人田径组的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四年级数学组、田径组的柱状图，请继续画16人音乐组的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了四年级数学组、田径组、音乐组的柱状图，请继续画15人美术组的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    if (done5==false){
                       comment = "你已经画出了四年级数学组、田径组、音乐组、美术组的柱状图，请继续画4人棋类组的柱状图。你画了" + (clickCount+1) + "次";
                    }else{
                       drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示画出实验小学四年级同学课外兴趣小组统计图。";
        comment2 = "即画出12人数学组、8人田径组、16人音乐组、15人美术组和4人棋类组的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","数学","","田径","","音乐","","美术","","棋类",""};
