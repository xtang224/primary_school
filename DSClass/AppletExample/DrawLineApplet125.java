...
class DrawLine125 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "请找到一季度电视机出售1500台的点,你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了一季度电视机出售1500台的所对应的点";
              comment2 = "请继续找二季度电视机出售1250台的所对应的点,你画了" + (clickCount+1) + "次;";
           }else{
              if (done3==false){
                 comment = "你已经找到了一、二季度电视机出售所对应的点";
                 comment2 = "请继续找三季度电视机出售2000台的所对应的点,你画了" + (clickCount+1) + "次;";
              }else{
                 if (done4==false){
                    comment = "你已经找到了一、二、三季度电视机出售所对应的点";
                    comment2 = "请继续找四季度电视机出售2300台的所对应的点,你画了" + (clickCount+1) + "次;";
                 }else{
                    if (done5==false){
                       comment = "你已经找到了一、二、三、四季度电视机出售所对应的点";
                       comment2 = "请继续找一季度音响出售500台的所对应的点,你画了" + (clickCount+1) + "次;";
                    }else{
                       if (done6==false){
                          comment = "你已经找到了一、二、三、四季度电视机出售和一季度音响出售所对应的点";
                          comment2 = "请继续二季度音响出售750台的所对应的点,你画了" + (clickCount+1) + "次;";
                       }else{
                          if (done7==false){
                             comment = "你已经找到了一、二、三、四季度电视机出售和一、二季度音响出售所对应的点";
                             comment2 = "请继续三季度音响出售600台的所对应的点,你画了" + (clickCount+1) + "次;";
                          }else{
                             if (done8==false){
                                comment = "你已经找到了一、二、三、四季度电视机出售和一、二、三季度音响出售所对应的点";
                                comment2 = "请继续四季度音响出售1500台的所对应的点,你画了" + (clickCount+1) + "次;";
                             }else{
        ...
        comment = "图中给出了坐标系，请画出电视机和音响的折线图。";   
        comment2 = "请找到一季度电视机出售1500台的点";     
     }   
  ...
  public void drawDemon(Graphics2D g2d){
     ...
     gp.moveTo(100, 40);
     gp.lineTo(160, 40);
     g2d.drawString("电视机", 160, 40);  
     dashLine(100,60,160,60,g2d);
     g2d.drawString("音响", 160, 60); 
     g2d.draw(gp);
  }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","一季度","二季度","三季度","四季度","","","","","",""};
