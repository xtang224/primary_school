...
public class DrawLineApplet111 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine111());
     
   }  
}

class DrawLine111 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterO2 = xcenterO + 7*30;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请点击选择点O向右平移7格后到达的点,你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了点O向右平移7格后到达的点";
              comment2 = "请继续找点A向右平移7格后到达的点,你画了" + (clickCount+1) + "次;";
           }else{
              if (done3==false){
                 comment = "你已经找到了点O，A向右平移7格后到达的点";
                 comment2 = "请继续找点B向右平移7格后到达的点,你画了" + (clickCount+1) + "次;";
              }else{
                 if (done4==false){
                    comment = "你已经找到了点O，A，B向右平移7格后到达的点";
                    comment2 = "请继续找点C向右平移7格后到达的点,你画了" + (clickCount+1) + "次;";
                 }else{
        ...
        comment = "图中给出了三角形小旗，请完成这个小旗向右平移7格后得到的图形。";   
       comment2 = "请点击选择点O向右平移7格后到达的点。";     
     }
