...
public class DrawLineApplet101 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine101());
     
   }  
}

class DrawLine101 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = xcenterO2-78;
  private static int ycenterA = ycenterO2-45; // Center position of A
  private static int xcenterB = xcenterO2+52;
  private static int ycenterB = ycenterO2+30; // Center position of B
  ...
  public void drawArc(Graphics2D g2d){
     ...
     g2d.drawString("学校", xcenterO2+10, ycenterO2-10); 
     /*
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){             
           ...
           g2d.drawString("超市", xcenterA-10, ycenterA+10); 
           g2d.drawString("30度", xcenterO2-40, ycenterO2); 
           gp.moveTo(xcenterO2,ycenterO2);
           gp.lineTo(xcenterA,ycenterA);                                
        }else{
        ...
        if (done2){             
           g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);      
           g2d.drawString("邮局", xcenterB+10, ycenterB+10); 
           gp.moveTo(xcenterO2,ycenterO2);
           gp.lineTo(xcenterB,ycenterB);                               
        }else{
           if (aroundPoint(startX2,startY2,xcenterB,ycenterB)){
              ...
              drawCorrect = true;                                        
              g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);  
              g2d.drawString("30度", xcenterO2+20, ycenterO2+10);     
              g2d.drawString("邮局", xcenterB+10, ycenterB+10);  
              gp.moveTo(xcenterO2,ycenterO2);
              gp.lineTo(xcenterB,ycenterB);             
           }           
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,超市在学校西偏北30度方向240米处，请点击选择超市所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了超市所对应的点。";
              comment2 = "邮局在学校东偏南30度方向160米处，请继续找邮局所对应的点,你画了" + (clickCount+1) + "次;";
           }else{
        ...
        comment = "如图，在图中标出超市和邮局的位置。";   
        comment2 = "超市在学校西偏北30度方向240米处，请点击选择超市所对应的点。";     
     }
