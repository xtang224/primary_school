...
class DrawLine131 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请首先沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第2个顶点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){            
              comment = "你已经沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第2个顶点。你画了" + (clickCount+1) + "次;"; 
              comment2 = "请继续沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第3个顶点";
           }else{
              if (done3==false){            
                 comment = "你已经沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第3个顶点。你画了" + (clickCount+1) + "次;"; 
                 comment2 = "请继续沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第4个顶点";
              }else{
                 if (done4==false){            
                    comment = "你已经沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第4个顶点。你画了" + (clickCount+1) + "次;"; 
                    comment2 = "请继续点击找到以这个正方形的上边为直径的圆";
                 }else{ 
                    if (done5==false){            
                       comment = "你已经找到了以这个正方形的上边为直径的圆,你画了" + (clickCount+1) + "次;"; 
                       comment2 = "请继续点击找到以这个正方形的下边为直径的圆";
                    }else{         
                       comment = "你完全画对了,你画了" + (clickCount+1) + "次;"; 
                       comment2 = "请继续回到原来页面做题";
                    }
                 }
              }
           }                  
        ...
        comment = "如图，图中给出了点A，请首先完成以A为左上端点的边长为4格的正方形，然后完成两个半圆，形成阴影部分。";   
        comment2 = "请首先沿着顺时针方向找到以A为左上端点的边长为4格的正方形的第2个顶点";     
     }
     g2d.setPaint(Color.red); 
