...
public class DrawLineApplet21 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine21());
     
   }  
}

class DrawLine21 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (clickCount>=0){
        if (done1==false){  
           if (target.equals("长方形"))         
              comment = "你还没有画对,请根据已有的长方形的两条边画出第四个顶点,你画了" + (clickCount+1) + "次;"; 
           else if (target.equals("正方形"))
              comment = "你还没有画对,请根据已有的正方形的一条左侧边画出第三个顶点,你画了" + (clickCount+1) + "次;"; 
           else // if (target.equals("平行四边形"))
              comment = "你还没有画对,请根据已有的平行四边形的两条边画出第四个顶点,你画了" + (clickCount+1) + "次;"; 
        }else{
           drawCorrect = true;
        ...
        if (target.equals("长方形"))      
           comment = "你还没有开始画，请用鼠标点击画线：请根据已有的长方形的两条边画出第四个顶点，完成这个长方形"; 
        else if (target.equals("正方形"))
           comment = "你还没有开始画，请用鼠标点击画线：请根据已有的正方形的一条左侧边画出第三个顶点，完成这个正方形";
        else
           comment = "你还没有开始画，请用鼠标点击画线：请根据已有的平行四边形的两条边画出第四个顶点，完成这个平行四边形";    
     }
