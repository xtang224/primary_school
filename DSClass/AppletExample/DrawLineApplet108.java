...
public class DrawLineApplet108 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine108());
     
   }  
}

class DrawLine108 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterB = xcenterO2-2*30;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,小冬家在小红家正西方2500米处，请点击选择小冬家所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
        ...
        comment = "如图，小红家距离学校1500米，小冬家在小红家正西方2500米处。";   
        comment2 = "请点击选择小冬家所对应的点。";     
     }
