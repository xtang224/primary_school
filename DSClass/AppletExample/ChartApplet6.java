...
public class ChartApplet6 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine6());
     
   }  
}

class ChartLine6 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 340; // Center position of A
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done2){
           g2d.fillRect(xcenterB, ycenterB, 40, 120);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请根据要求先画出全班8人喜欢体育的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了全班喜欢体育的柱状图，请继续画全班6人喜欢新闻的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了全班喜欢体育,新闻的柱状图，请继续画全班16人喜欢娱乐的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4 == false){
                    comment = "你已经画出了全班喜欢体育,新闻，娱乐的柱状图，请继续画全班20人喜欢儿童的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出全班喜欢体育,新闻，娱乐和儿童节目的柱状图。";
        comment2 = "即画出8人喜欢体育、6人喜欢新闻、16人喜欢娱乐和20人喜欢儿童电视节目的条形统计图。"; 
     }
