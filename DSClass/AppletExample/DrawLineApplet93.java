...
public class DrawLineApplet93 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine93());
     
   }  
}

class DrawLine93 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterO = 150; // Center position of O
  ...
  public void drawArc(Graphics2D g2d){
     ...
     g2d.draw(gp);
     g2d.drawString("底", xcenterB+20, (ycenterB+ycenterC)/2);
     /*
