...
public class DrawLineApplet114 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine114());
     
   }  
}

class DrawLine114 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = xcenterO2 + 3*30;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     g2d.drawString("广场", xcenterO2+10, ycenterO2-10); 
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,小冬家在广场北偏西方向60度600m处，请点击选择小冬家所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
        ...
        comment = "如图，在图中标出小冬家的位置。";   
        comment2 = "小冬家在广场北偏西方向60度600m处，请点击选择小冬家所对应的点。";     
     }
