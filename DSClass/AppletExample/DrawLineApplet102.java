...
public class DrawLineApplet102 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine102());
     
   }  
}

class DrawLine102 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterB = xcenterO2+78;
  private static int ycenterB = ycenterO2-45; // Center position of B
  ...
  public void drawArc(Graphics2D g2d){
     ...
     g2d.drawString("少年宫", xcenterO2+10, ycenterO2-10); 
     /*
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){             
           ...
           g2d.drawString("小艳家", xcenterA-10, ycenterA+10); 
        ...
        if (done2){             
           g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);      
           g2d.drawString("小龙家", xcenterB+10, ycenterB+10); 
           gp.moveTo(xcenterO2,ycenterO2);
           gp.lineTo(xcenterB,ycenterB);                               
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,小艳家在少年宫正北方向1000米处，请点击选择小艳家所对应的点。你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){
              comment = "你已经找到了小艳家所对应的点。";
              comment2 = "小龙家在少年宫东偏北30度方向1500米处，请继续找小龙家所对应的点,你画了" + (clickCount+1) + "次;";
           }else{
        ...
        comment = "如图，在图中标出小艳家和小龙家的位置。";   
        comment2 = "小艳家在少年宫正北方向1000米处，请点击选择小艳家所对应的点。";     
     }
