...
public class DrawLineApplet98 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine98());
     
   }  
}

class DrawLine98 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterB = ycenterA+1*30; // Center position of B
  private static int xcenterC = xcenterB+3*30;
  private static int ycenterC = ycenterB+1*30; // Center position of C  
  private static int xcenterD = xcenterC+1*30;
  private static int ycenterD = ycenterC+5*30; // Center position of D
  
  private static int xcenterO2 = (2*xcenterO+xcenterD)/3;
  private static int ycenterO2 = (2*ycenterO+ycenterD)/3; // Center position of O2
