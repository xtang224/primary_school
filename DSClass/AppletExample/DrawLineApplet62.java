...
public class DrawLineApplet62 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine62());
     
   }  
}

class DrawLine62 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请在点A的右侧找到另外一个长方形的顶点,你画了" + (clickCount+1) + "次;"; 
        }else{           
