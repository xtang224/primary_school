...
public class DrawLineApplet59 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine59());
     
   }  
}

class DrawLine59 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (clickCount>=0){
        ...
        if (done4){  
           gp.moveTo(xcenterD,ycenterD);
           gp.lineTo(xcenterLH,ycenterLH); 
           gp.moveTo(xcenterLH,ycenterLH);
           gp.lineTo(xcenterLH2,ycenterLH2);  
           gp.moveTo(xcenterLH2,ycenterLH2);
           gp.lineTo(xcenterH2,ycenterH2);           
        }else{
           if (aroundPoint(startX4,startY4,xcenterLH,ycenterLH) || aroundPoint(startX4,startY4,xcenterLH2,ycenterLH2)){
              done4 = true;   
              drawCorrect = true;            
              gp.moveTo(xcenterD,ycenterD);
              gp.lineTo(xcenterLH,ycenterLH); 
