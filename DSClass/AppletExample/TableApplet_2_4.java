...
public class TableApplet_2_4 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new TablePanel_2_4());
   }
}

class TablePanel_2_4 extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"因数",
                                        ...
                                        "积"};
        private Object[][] data = {
	    {new Integer(36), new Integer(45), new Integer(-1)},
	    {new Integer(-1), new Integer(26), new Integer(364)},
            {new Integer(12), new Integer(-1), new Integer(84)}	    
        };
