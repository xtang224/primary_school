...
public class DrawLineApplet88 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine88());
     
   }  
}

class DrawLine88 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = 150+30*2;
  private static int ycenterA = 250; // Center position of A
  private static int xcenterB = 150-25*3;
  private static int ycenterB = ycenterA; // Center position of B
  private static int xcenterC = 150+5*3;
  private static int ycenterC = ycenterA; // Center position of C  
  private static int xcenterD = 150-15*3;
  ...
  private static int xcenterO = 150-30*3;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){          
           g2d.fillArc(xcenterO-5, ycenterO-5, 10, 10, 0, 360);      
           g2d.drawString("-3", xcenterO-10, ycenterO-10);                   
        }else{
        ...
        if (done2){          
           g2d.fillArc(xcenterA-5, ycenterA-5, 10, 10, 0, 360);      
           g2d.drawString("+2", xcenterA-10, ycenterA-10);                   
        }else{
           if (aroundPoint(startX2,startY2,xcenterA,ycenterA)){
              done2 = true;               
              g2d.fillArc(xcenterA-5, ycenterA-5, 10, 10, 0, 360);      
              g2d.drawString("+2", xcenterA-10, ycenterA-10);                           
           }           
        ...
        if (done3){          
           g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);      
           g2d.drawString("-2.5", xcenterB-10, ycenterB-10);                   
        }else{
           if (aroundPoint(startX3,startY3,xcenterB,ycenterB)){
              done3 = true;              
              g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);      
              g2d.drawString("-2.5", xcenterB-10, ycenterB-10);                           
           }           
        ...
        if (done4){          
           g2d.fillArc(xcenterC-5, ycenterC-5, 10, 10, 0, 360);      
           g2d.drawString("+0.5", xcenterC-10, ycenterC-10);                   
        }else{
           if (aroundPoint(startX4,startY4,xcenterC,ycenterC)){
              done4 = true;               
              g2d.fillArc(xcenterC-5, ycenterC-5, 10, 10, 0, 360);      
              g2d.drawString("+0.5", xcenterC-10, ycenterC-10);                           
           }           
        ...
        if (done5){          
           g2d.fillArc(xcenterD-5, ycenterD-5, 10, 10, 0, 360);      
           g2d.drawString("-3/2", xcenterD-10, ycenterD-10);                   
        }else{
           if (aroundPoint(startX5,startY5,xcenterD,ycenterD)){
              done5 = true;  
              drawCorrect = true;           
              g2d.fillArc(xcenterD-5, ycenterD-5, 10, 10, 0, 360);      
              g2d.drawString("-3/2", xcenterD-10, ycenterD-10);                           
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请在数轴上表示-3，你画了" + (clickCount+1) + "次;";                   
        }else{
           if (done2==false){          
              comment = "你已经在数轴上表示-3，请继续在数轴上表示2，你画了" + (clickCount+1) + "次;"; 
           }else{                
              if (done3==false){                 
                 comment = "你已经在数轴上表示-3,2，请继续在数轴上表示-2.5，你画了" + (clickCount+1) + "次;"; 
              }else{
                 if (done4==false){
                    comment = "你已经在数轴上表示-3,2,-2.5，请继续在数轴上表示+0.5，你画了" + (clickCount+1) + "次;";
                 }else{
                    if (done5==false){
                       comment = "你已经在数轴上表示-3,2,-2.5,+0.5，请继续在数轴上表示-3/2，你画了" + (clickCount+1) + "次;";
                    }else{
        ...
        comment = "图中给出了一个数轴，在数轴上依次表示各数：-3，2，-2.5，+0.5，-3/2;";             
     }
