...
public class DrawLineApplet81 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine81());
     
   }  
}

class DrawLine81 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     if (clickCount>=0){
        ...
        if (done1){  
           g2d.fillArc(xcenterA-5, ycenterA-5, 10, 10, 0, 360);            
           g2d.drawString("-1.5", xcenterA-5, ycenterA-10);                       
        }else{
        ...
        if (done2){  
           g2d.fillArc(xcenterB-5, ycenterB-5, 10, 10, 0, 360);
           g2d.drawString("3", xcenterB-5, ycenterB-10);                   
        }else{
        ...
        if (done3){  
           g2d.fillArc(xcenterC-5, ycenterC-5, 10, 10, 0, 360);
           g2d.drawString("-2.5", xcenterC-5, ycenterC-10);                   
        }else{
        ...
        if (done4){  
           g2d.fillArc(xcenterD-5, ycenterD-5, 10, 10, 0, 360);
           g2d.drawString("-2", xcenterD-5, ycenterD-10);                   
        }else{
        ...
        if (done5){  
           ...
           g2d.drawString("2.5", xcenterE-5, ycenterE-10);                   
        }else{
        ...
        if (done6){  
           ...
           g2d.drawString("1", xcenterF-5, ycenterF-10);                   
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请在数轴上找到-1.5,你画了" + (clickCount+1) + "次;";           
        }else{
           if (done2==false){
              comment = "你已经找到了-1.5,请继续在数轴上找3,你画了" + (clickCount+1) + "次;";               
           }else{
              if (done3==false){
                 comment = "你已经找到了-1.5，3,请继续在数轴上找-2.5,你画了" + (clickCount+1) + "次;"; 
              }else{
                 if (done4==false){
                    comment = "你已经找到了-1.5，3,-2.5,请继续在数轴上找-2,你画了" + (clickCount+1) + "次;"; 
                 }else{  
                    if (done5==false){
                       comment = "你已经找到了-1.5，3,-2.5,-2,请继续在数轴上找2.5,你画了" + (clickCount+1) + "次;"; 
                    }else{ 
                       if (done6==false){
                          comment = "你已经找到了-1.5，3,-2.5,-2,2.5,请继续在数轴上找1,你画了" + (clickCount+1) + "次;"; 
                       }else 
        ...
        comment = "图中给出了数轴，请在数轴上依次标出-1.5，3，-2.5，-2，2.5，1;";             
     }
