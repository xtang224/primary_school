...
public class DrawLineApplet106 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine106());
     
   }  
}

class DrawLine106 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = ycenterO - 7*30; // Center position of A
  ...
  private static int xcenterA2 = xcenterO + 1*30;
  private static int ycenterA2 = ycenterO - 1*30;
  ...
  private static int xcenterD2 = xcenterC2 - 4*30;
  private static int ycenterD2 = ycenterC2 + 4*30;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        if (done1==false){            
           comment = "你还没有画对,请点击选择在放大的平行四边形中点B所对应的点,你画了" + (clickCount+1) + "次;"; 
           comment2 = "";
        }else{
           if (done2==false){            
              comment = "你已经找到了在放大的平行四边形中点B所对应的点,你画了" + (clickCount+1) + "次;";
              comment2 = "请继续点击选择在放大的平行四边形中点C所对应的点";
           }else{
              if (done3==false){            
                 comment = "你已经找到了在放大的平行四边形中点B、C所对应的点,你画了" + (clickCount+1) + "次;";
                 comment2 = "请继续点击选择在放大的平行四边形中点D所对应的点";
              }else{
        ...
        comment = "图中给出了平行四边形ABCD，请画出将其按1：2放大后的图形。";        
        comment2 = "A2是放大后的平行四边形中对应于A的顶点，请点击选择B对应的点";        
     }
