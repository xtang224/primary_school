...
public class ChartApplet11 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine11());
     
   }  
}

class ChartLine11 extends JPanel implements MouseListener, ActionListener
{
