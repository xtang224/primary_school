...
public final class SmartRandom2Action extends Action {
    ...
    throws Exception {
        ...
        String classId = (String)((SmartRandom2Form) form).getClassId();
        ...
        String answeredHashSetStr_ftb = (String)((SmartRandom2Form) form).getAnsweredHashSet_ftb();
        ...
        String answeredHashSetStr_m = (String)((SmartRandom2Form) form).getAnsweredHashSet_m();  
        hs_m = StringSetTransfer.stringToSet(answeredHashSetStr_m); 
        String answeredHashSetStr_d = (String)((SmartRandom2Form) form).getAnsweredHashSet_d();  
        hs_d = StringSetTransfer.stringToSet(answeredHashSetStr_d);  
        String answeredHashSetStr_pm = (String)((SmartRandom2Form) form).getAnsweredHashSet_pm();  
     ...
     if (id != 0){
           ...
           switch (randomNumber){
              case 0:
               ...
               case 6:
                  ...
                  System.out.println("at initiation in SmartRandomA2ctioin: fqbb is reached");
                  break;   
               case 7:
                  if (id>=133 && id<=134){
                  ...
                  System.out.println("at initiation in SmartRandom2Actioin: ftbb is reached");
                  break;  
               case 8:
                  ...
                  System.out.println("at initiation in SmartRandom2Actioin: mb is reached");       
                  break; 
               case 9:
                  ...
                  System.out.println("at initiation in SmartRandom2Actioin: db is reached");
                  break;
               case 10:
                  ...
                  System.out.println("at initiation in SmartRandom2Actioin: pmb is reached");       
                  break;         
               default:
                  break;
        ...
        System.out.println("SmartRandom2Action, hs_ftb str is " + StringSetTransfer.setToString(hs_ftb));
        ...
        System.out.println("SmartRandom2Action, hs_m str is " + StringSetTransfer.setToString(hs_m));                      
        System.out.println("SmartRandom2Action, hs_d str is " + StringSetTransfer.setToString(hs_d)); 
        System.out.println("SmartRandom2Action, hs_pm str is " + StringSetTransfer.setToString(hs_pm));                      
