...
public final class SmartRandom4Action extends Action {
    ...
    throws Exception {
        ...
        PersonBean pb2 = null;
        pb2 = new PersonBean();
        String userName = (String)((SmartRandom4Form) form).getUserName();
        String passWord = (String)((SmartRandom4Form) form).getPassWord();
        String trueName = (String)((SmartRandom4Form) form).getTrueName();
        String playerId = (String)((SmartRandom4Form) form).getPlayerId();
        pb2.setUserName(userName);
        pb2.setPassWord(passWord); 
        pb2.setTrueName(trueName);
        pb2.setPlayerId(playerId);  

        String times = (String)((SmartRandom4Form) form).getTimes();
        pb2.setTimes(times);

        String planStatus = (String)((SmartRandom4Form) form).getPlanStatus();
        pb2.setPlanStatus(planStatus);

        String classId = (String)((SmartRandom4Form) form).getClassId();
        pb2.setClassId(classId);

        String source = (String)((SmartRandom4Form) form).getSource();
        ...
        //String TOMCAT_PATH = "I:\\Dongshan\\Tomcat_6\\reverseTest\\grade6_2nd";
        String cNote = "\\";
 ...
 System.out.println("the total number of questions: " + (StringSetTransfer.total_fb+StringSetTransfer.total_fdb+StringSetTransfer.total_ftb+StringSetTransfer.total_fqb+StringSetTransfer.mtotal+StringSetTransfer.total_tf+StringSetTransfer.total+StringSetTransfer.total_m+StringSetTransfer.total_d+StringSetTransfer.total_pm) + "");
            ...
            String answeredHashSetStr = (String)((SmartRandom4Form) form).getAnsweredHashSet();
            hs = StringSetTransfer.stringToSet(answeredHashSetStr);
            String answeredHashSetStr_tf = (String)((SmartRandom4Form) form).getAnsweredHashSet_tf();
            hs_tf = StringSetTransfer.stringToSet(answeredHashSetStr_tf);
            String answered_M_HashSetStr = (String)((SmartRandom4Form) form).getAnswered_M_HashSet();
            mhs = StringSetTransfer.stringToSet(answered_M_HashSetStr);
            String answeredHashSetStr_fb = (String)((SmartRandom4Form) form).getAnsweredHashSet_fb();
            hs_fb = StringSetTransfer.stringToSet(answeredHashSetStr_fb);            
            String answeredHashSetStr_fdb = (String)((SmartRandom4Form) form).getAnsweredHashSet_fdb();
            hs_fdb = StringSetTransfer.stringToSet(answeredHashSetStr_fdb);
            String answeredHashSetStr_ftb = (String)((SmartRandom4Form) form).getAnsweredHashSet_ftb();
            hs_ftb = StringSetTransfer.stringToSet(answeredHashSetStr_ftb);
            String answeredHashSetStr_fqb = (String)((SmartRandom4Form) form).getAnsweredHashSet_fqb();
            hs_fqb = StringSetTransfer.stringToSet(answeredHashSetStr_fqb);
            String answeredHashSetStr_tm = (String)((SmartRandom4Form) form).getAnsweredHashSet_tm();  
            hs_tm = StringSetTransfer.stringToSet(answeredHashSetStr_tm);           
            String answeredHashSetStr_m = (String)((SmartRandom4Form) form).getAnsweredHashSet_m();  
            hs_m = StringSetTransfer.stringToSet(answeredHashSetStr_m);
            String answeredHashSetStr_d = (String)((SmartRandom4Form) form).getAnsweredHashSet_d();  
            hs_d = StringSetTransfer.stringToSet(answeredHashSetStr_d);
            String answeredHashSetStr_pm = (String)((SmartRandom4Form) form).getAnsweredHashSet_pm();  
        ...
        String lastType = (String)((SmartRandom4Form) form).getLastType();
        String thisType = (String)((SmartRandom4Form) form).getThisType();
        String continueRight = (String)((SmartRandom4Form) form).getContinueRight();
        String continueWrong = (String)((SmartRandom4Form) form).getContinueWrong();
        int intContinueRight = Integer.parseInt(continueRight);
        int intContinueWrong = Integer.parseInt(continueWrong);
        String neverHigh = (String)((SmartRandom4Form) form).getNeverHigh();
        boolean boolNeverHigh = Boolean.parseBoolean(neverHigh);
        System.out.println("Inside SmartRandom4Action.java, lastType = " + lastType);
        ...
        String lastCorrect = (String)((SmartRandom4Form) form).getLastCorrect();
        System.out.println("Inside SmartRandom4Action.java, lastCorrect = " + lastCorrect);
        ...
        while (true){  
           ...
           id = 0;           
             ...
             //up to this point, we have decided the value of thisChar for both first==true and first!=true
                 ...
                 System.out.println("Inside SmartRandom4Action, thisType = " + thisType);
                 //below we will not care about any used set when we decide whether low,middle,high are used up
                 switch (thisType.charAt(0)){
                    case 'L':
                       System.out.println("Inside SmartRandom4Action, case 'L', thisType = " + thisType);
     ...
     System.out.println("Inside SmartRandom4Action, after id and randomNumber is obtained, id = " + id + " and randomNumber = " + randomNumber);
     ...
     if (id != 0){
           ...
           switch (randomNumber){
              case 0:
               ...
               case 1:
                  ...
                  //getServlet().log("inside SmartRandom4Action.java, when select * from choices2 where id=?,  id = " + id);
                  stmt.clearParameters();
                  stmt.setInt(1, id);
                  rs = stmt.executeQuery();
                  while (rs.next()){
               ...
               case 6:
                  ...
                  System.out.println("at initiation in SmartRandom4Actioin: fqbb is reached");
                  break;  
               case 7:
                  if (id>=133 && id<=134){
                  ...
                  System.out.println("at initiation in SmartRandom4Actioin: ftbb is reached");
                  break;
               case 8:
                  ...
                  System.out.println("at initiation in SmartRandom4Actioin: mb is reached");       
                  break; 
               case 9:
                  ...
                  System.out.println("at initiation in SmartRandom4Actioin: db is reached");
                  break;  
               case 10:
                  ...
                  System.out.println("at initiation in SmartRandom4Actioin: pmb is reached");       
                  break;                       
               default:
                  break;
        ...
        System.out.println("at SmartRandom4Action, hs string is " + StringSetTransfer.setToString(hs));
        System.out.println("SmartRandom4Action, hs_tf str is " + StringSetTransfer.setToString(hs_tf));
        System.out.println("SmartRandom4Action, mhs str is " + StringSetTransfer.setToString(mhs));   
        System.out.println("SmartRandom4Action, hs_fb str is " + StringSetTransfer.setToString(hs_fb));   
        System.out.println("SmartRandom4Action, hs_fdb str is " + StringSetTransfer.setToString(hs_fdb));
        System.out.println("SmartRandom4Action, hs_ftb str is " + StringSetTransfer.setToString(hs_ftb));
        System.out.println("SmartRandom4Action, hs_fqb str is " + StringSetTransfer.setToString(hs_fqb));
        System.out.println("SmartRandom4Action, hs_tm str is " + StringSetTransfer.setToString(hs_tm));                      
        System.out.println("SmartRandom4Action, hs_m str is " + StringSetTransfer.setToString(hs_m));                      
        System.out.println("SmartRandom4Action, hs_d str is " + StringSetTransfer.setToString(hs_d));
        System.out.println("SmartRandom3Action, hs_pm str is " + StringSetTransfer.setToString(hs_pm)); 
        
        String answeredProblems = (String)((SmartRandom4Form) form).getAnsweredProblems();
        String correctAnswers = (String)((SmartRandom4Form) form).getCorrectAnswers();
        ...
        String totalScore = (String)((SmartRandom4Form) form).getTotalScore();
        String correctAnswers_low = (String)((SmartRandom4Form) form).getCorrectAnswers_low();
        String answeredProblems_low = (String)((SmartRandom4Form) form).getAnsweredProblems_low();
        ...
        String correctAnswers_middle = (String)((SmartRandom4Form) form).getCorrectAnswers_middle();
        String answeredProblems_middle = (String)((SmartRandom4Form) form).getAnsweredProblems_middle();        
        ...
        String correctAnswers_high = (String)((SmartRandom4Form) form).getCorrectAnswers_high();
        String answeredProblems_high = (String)((SmartRandom4Form) form).getAnsweredProblems_high();        
        ...
        while(true){
           try{
              ...
              getServlet().log("Inside SmartRandom4Action.java, process.", ex);
           }finally{
              try{
                 if (rs != null) rs.close();
                 if (s != null) s.close();
                 ...
                 getServlet().log("Inside SmartRandom4Action.java, closing.", e);
              }
           } 
        }
        ...
        while (iter.hasNext()) {
           if (index == selectNumber){
              ...
              System.out.println("inside SmartRandom4Action, the selected student = " + tempUserName);
              break;
           }
           iter.next();
           index++;                      
