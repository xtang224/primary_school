...
public final class SmartRandom5Form extends ActionForm {
    ...
    private String answeredHashSet_ftb = null; 
    private String answeredHashSet_fqb = null; 
    private String answeredHashSet_tm = null; 
    private String answeredHashSet_m = null; 
    private String answeredHashSet_d = null; 
    private String answeredHashSet_pm = null; 
    ...
    public String getAnsweredHashSet_ftb() {
        return (this.answeredHashSet_ftb);
    }
    ...
    public String getAnsweredHashSet_m() {
        return (this.answeredHashSet_m);
    }

    public String getAnsweredHashSet_d() {
        return (this.answeredHashSet_d);
    }

    public String getAnsweredHashSet_pm() {
        return (this.answeredHashSet_pm);
    }
...
/*********************************/
    ...
    public void setAnsweredHashSet_ftb(String answeredHashSet_ftb) {
        this.answeredHashSet_ftb = answeredHashSet_ftb;
    }
    ...
    public void setAnsweredHashSet_m(String answeredHashSet_m) {
        this.answeredHashSet_m = answeredHashSet_m;
    }

    public void setAnsweredHashSet_d(String answeredHashSet_d) {
        this.answeredHashSet_d = answeredHashSet_d;
    }

    public void setAnsweredHashSet_pm(String answeredHashSet_pm) {
        this.answeredHashSet_pm = answeredHashSet_pm;
    }
