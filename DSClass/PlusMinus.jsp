   ...
   <html:errors/><p> 
    ...
    <logic:present name="plusminusbean" scope="session">
       <h2>
         ...
         <bean:write name="plusminusbean" property="preResult" /><br> 
       </h2>
    </logic:present>
    ...
    <html:form action="/SmartRandomCheck.do" >
      <bean:message key="hello.jsp.page.plusminus"/>
      <html:text property="inputAnswer" size="16" maxlength="100" /><br>      
      
      <html:hidden property="factor1" value="<%= _pmb.getFactor1()%>"/>
      <html:hidden property="factor2" value="<%= _pmb.getFactor2()%>"/>      
      <html:hidden property="result" value="<%= _pmb.getResult()%>"/>      
      <html:hidden property="source" value="<%= _pmb.getSource()%>"/> 
