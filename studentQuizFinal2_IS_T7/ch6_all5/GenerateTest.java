...
public class GenerateTest {
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIds(){
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "Choices2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "Multiply_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "MultipleQuestions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath10 + "\\" + "Division_test_used.txt";
      saveFile();
   }
