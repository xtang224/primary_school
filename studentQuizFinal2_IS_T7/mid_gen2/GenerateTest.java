...
public class GenerateTest {
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIds(){
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\" + "Choices2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\" + "Multiply_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\" + "MultipleQuestions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
   }
