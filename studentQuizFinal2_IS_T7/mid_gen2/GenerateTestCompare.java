...
public class GenerateTestCompare {
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIdsCompare(){
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\compare" + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\compare" + "\\" + "Choices2_test_used.txt";
      saveFile();      
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\compare" + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + "\\compare"  + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
   }
   ...
   public void saveTestIdsForAndroid(){
      ...
      filePath = TOMCAT_PATH + subPath2 + comparePath + subAndroidPath + "\\" + "Questions2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + comparePath + subAndroidPath + "\\" + "Choices2_test_usedForAndroid.txt";
      saveFile();     
      ...
      filePath = TOMCAT_PATH + subPath2 + comparePath + subAndroidPath + "\\" + "FillBlank2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath2 + comparePath + subAndroidPath + "\\" + "FillDoubleBlanks2_test_usedForAndroid.txt";
      saveFile();
   }
