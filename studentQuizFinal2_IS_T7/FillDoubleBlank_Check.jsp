  ...
  <body bgcolor="white"><p>   
   ...
   <html:errors/><p> 
    ...
    <logic:present name="filldoubleblankbean" scope="request">
       <h2>         
         <bean:write name="filldoubleblankbean" property="statement_1st" />         
         <bean:write name="filldoubleblankbean" property="yourSolution_1st" />    
         <bean:write name="filldoubleblankbean" property="statement_2nd" />
         <bean:write name="filldoubleblankbean" property="yourSolution_2nd" />    
         <bean:write name="filldoubleblankbean" property="statement_3rd" /><P> 
       </h2>
    </logic:present>
