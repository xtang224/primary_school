...
public class GenerateTestDirect {
  ...
  private final String TEST_PATH = "E:\\Teaching\\°²À¼Ð¡Ñ§\\test\\pic";
  ...
  private String subPath7 = "\\ch56_all";
  ...
  public static void main(String[] args) {
   ...
   public void saveTestPaper(){
      filePath = TOMCAT_PATH + subPath7 + "\\" + "generated_test_paper_ch56_all.txt";
      saveFile();
   }
