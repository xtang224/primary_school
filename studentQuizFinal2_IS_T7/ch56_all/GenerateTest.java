...
public class GenerateTest {
  ...
  private String subPath10 = "\\ch6_all5";
  private String subPath11 = "\\ch6_all6";
  private String subPath12 = "\\ch56_all";
  ...
  private String[] sources = new String[]{"ch5_1", "ch5_2", "ch5_3", "ch5_4", "ch5_5", "ch5_6", "ch5_self", "ch5_hk", "ch5", "ch5_add", "ch6_1", "ch6_2", "ch6_3", "ch6_4",  "ch6_5", "ch6_6", "ch6_7", "ch6_8", "ch6_9", "ch6_10", "ch6_hk", "ch6_hk2", "ch6"};  
  ...
  public static void main(String[] args) {
   ...
   public void initUsedSet(){
      ...
      filePath = TOMCAT_PATH + subPath10;
      addSetFromPath(filePath + "\\" + "Questions2_test_used.txt", hs_used);
      addSetFromPath(filePath + "\\" + "Choices2_test_used.txt", hs_tf_used);
      addSetFromPath(filePath + "\\" + "FillBlank2_test_used.txt", hs_fb_used); 
      addSetFromPath(filePath + "\\" + "FillDoubleBlanks2_test_used.txt", hs_fdb_used); 
   ...
   public void initSet(){
     try{
        ...
        //now we want to only get 5 fillBlank2 for this generated test
        tmpSet = new HashSet();
        controlSet = new HashSet();
        obs = hs_fb.toArray();
        total = Math.min(5, obs.length);
        ...
        //now we want to only get 5 fillDoubleBlanks2 for this generated test
        tmpSet = new HashSet();
        controlSet = new HashSet();
        obs = hs_fdb.toArray();
        total = Math.min(5, obs.length);
        ...
        //now we want to get 5 divisions
        tmpSet = new HashSet();
        controlSet = new HashSet();
        obs = hs_d.toArray();
        total = Math.min(5, obs.length);
   ...
   public void saveTestIds(){
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "Choices2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "Multiply_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "MultipleQuestions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath12 + "\\" + "Division_test_used.txt";
      saveFile();
   }
