...
public class GenerateTestCompare {
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIdsCompare(){
      ...
      filePath = TOMCAT_PATH + subPath4 + "\\compare" + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath4 + "\\compare" + "\\" + "Choices2_test_used.txt";
      saveFile();      
      ...
      filePath = TOMCAT_PATH + subPath4 + "\\compare" + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath4 + "\\compare"  + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
   }
   ...
   public void saveTestIdsForAndroid(){
      ...
      filePath = TOMCAT_PATH + subPath4 + comparePath + subAndroidPath + "\\" + "Questions2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath4 + comparePath + subAndroidPath + "\\" + "Choices2_test_usedForAndroid.txt";
      saveFile();     
      ...
      filePath = TOMCAT_PATH + subPath4 + comparePath + subAndroidPath + "\\" + "FillBlank2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath4 + comparePath + subAndroidPath + "\\" + "FillDoubleBlanks2_test_usedForAndroid.txt";
      saveFile();
   }
