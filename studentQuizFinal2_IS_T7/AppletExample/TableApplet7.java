...
public class TableApplet7 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table7Panel());
   }
}

class Table7Panel extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"", "大米", "白糖", "咸化饼干"};
        private Object[][] data = {	    
            {"总价/元", new Integer(150), new Integer(20), new Integer(-1)},
	    {"数量/千克", new Integer(50), new Integer(-1), new Integer(6)},
            {"单价/元", new Integer(-1), new Integer(4), new Integer(3)}
        };
