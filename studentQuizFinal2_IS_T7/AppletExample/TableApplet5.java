...
public class TableApplet5 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table5Panel());
   }
}

class Table5Panel extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          ...
          Integer class2Value = (Integer)myTable.getValueAt(1,1);
          ...
          if (done){
             try{       
                connect();    
                target = "Table"+";"+class1Value+";"+class2Value;
                /*                    
                ptmt = dbCon.prepareStatement("select term2 from hintMatch where term1=?");
                ptmt.clearParameters();
                ptmt.setString(1, "table"); 
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"月份", "合计", "一月", "二月", "三月"};
        private Object[][] data = {	    
            {"儿童读物", new Integer(8200), new Integer(2500), new Integer(-1), new Integer(2700)},
	    {"成人读物", new Integer(-1), new Integer(3400), new Integer(3000), new Integer(2700)}
        };
