...
public class ChartApplet21 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine21());
     
   }  
}

class ChartLine21 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = 100 + 232;
  private static int ycenterA = 460; // Center position of A
  private static int xcenterB = 100 + 320;
  private static int ycenterB = 380; // Center position of B
  private static int xcenterC = 100 + 260;
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("华隆商场今年第三季度品牌电饭锅销售统计图", 150, 50);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA-232, ycenterA-40, 232, 40);              
        }else{
        ...
        if (done2){
           g2d.fillRect(xcenterB-320, ycenterB-40, 320, 40);            
        }else{
        ...
        if (done3){
           g2d.fillRect(xcenterC-260, ycenterC-40, 260, 40);         
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出甲品牌销售580台的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了甲品牌销售的柱状图，请继续画乙品牌销售800台的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了甲、乙品牌销售的柱状图，请继续丙品牌销售650台的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出华隆商场今年第三季度销售电饭锅的柱状图。";
        comment2 = "即画出甲品牌580台、乙品牌800台和丙品牌650台的条形统计图。"; 
     }
