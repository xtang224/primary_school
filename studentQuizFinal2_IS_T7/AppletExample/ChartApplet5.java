...
public class ChartApplet5 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine5());
     
   }  
}

class ChartLine5 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 420; // Center position of A
  private static int xcenterB = 220;
  private static int ycenterB = 460; // Center position of B
  private static int xcenterC = 300;
  private static int ycenterC = 300; // Center position of C  
  private static int xcenterD = 380;
  private static int ycenterD = 260; // Center position of D
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA, ycenterA, 40, 80);              
        }else{
        ...
        if (done2){
           g2d.fillRect(xcenterB, ycenterB, 40, 40);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请根据要求先画出第一小组2人喜欢体育的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了第一小组喜欢体育的柱状图，请继续画第一小组1人喜欢新闻的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了第一小组喜欢体育,新闻的柱状图，请继续画第一小组5人喜欢娱乐的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4 == false){
                    comment = "你已经画出了第一小组喜欢体育,新闻，娱乐的柱状图，请继续画第一小组6人喜欢儿童的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出第一小组喜欢体育,新闻，娱乐和儿童节目的柱状图。";
        comment2 = "即画出2人喜欢体育、1人喜欢新闻、5人喜欢娱乐和6人喜欢儿童电视节目的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","体育","新闻","娱乐","儿童",""};
     int intV = 0;
     for (int i=0; i<100; i++){        
        if (i % 20 == 0){
           intV = i/20;           
