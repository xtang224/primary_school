...
public class TableApplet12 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table12Panel());
   }
}

class Table12Panel extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"班级", "四（1）班", "四（2）班", "四（3）班", "四（4）班"};
        private Object[][] data = {           
            {"本数", new Integer(-1), new Integer(-1), new Integer(-1), new Integer(-1)}
        };
