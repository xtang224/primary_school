...
public class ChartApplet16 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine16());
     
   }  
}

class ChartLine16 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterC = 500-300; // Center position of C  
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("希望小学四年级各班近视学生人数统计图", 150, 60);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done3){
           g2d.fillRect(xcenterC, ycenterC, 40, 300);         
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出四（1）班14名近视学生的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四（1）班近视学生的柱状图，请继续画四（2）班12名近视学生的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四（1）班、四（2）班近视学生的柱状图，请继续画四（3）班15名学生的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了四（1）班、四（2）班、四（3）班近视学生的柱状图，请继续画四（4）班10名学生的柱状图。你画了" + (clickCount+1) + "次";
                 }else{                    
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出四年级各班近视学生的柱状图。";
        comment2 = "即画出四（1）班14名、四（2）班12名、四（3）班15名和四（4）班10名近视学生的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","四（1）班","","四（2）班","","四（3）班","","四（4）班","","","班别"};
