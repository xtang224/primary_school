...
public class ChartApplet8 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine8());
     
   }  
}

class ChartLine8 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = 236;
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA-136, ycenterA-40, 136, 40);              
        }else{
