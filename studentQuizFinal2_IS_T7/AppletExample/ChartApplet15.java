...
public class ChartApplet15 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine15());
     
   }  
}

class ChartLine15 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 500-128; // Center position of A
  private static int xcenterB = 220;
  private static int ycenterB = 500-160; // Center position of B
  private static int xcenterC = 300;
  private static int ycenterC = 500-14*8; // Center position of C  
  private static int xcenterD = 380;
  private static int ycenterD = 500-128; // Center position of D
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("四年级女同学喜欢的水果统计图", 200, 300);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA, ycenterA, 40, 128);              
        }else{
        ...
        if (done3){
           g2d.fillRect(xcenterC, ycenterC, 40, 14*8);         
        }else{
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 128);            
        }else{
        ...
        if (done5){
           g2d.fillRect(xcenterE, ycenterE, 40, 120);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出16个苹果的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了苹果的柱状图，请继续画20个桔子的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了苹果、桔子的柱状图，请继续画14个桃子的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了苹果、桔子、桃子的柱状图，请继续画16个梨的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    if (done5==false){
                       comment = "你已经画出了苹果、桔子、桃子、梨的柱状图，请继续画15个香蕉的柱状图。你画了" + (clickCount+1) + "次";
                    }else{
                       drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出四年级女同学喜欢的各种水果的柱状图。";
        comment2 = "即画出16个苹果、20个桔子、14个桃子、16个梨和15个香蕉的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","苹果","","桔子","","桃子","","梨","","香蕉",""};
