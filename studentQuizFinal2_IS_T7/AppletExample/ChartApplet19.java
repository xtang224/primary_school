...
public class ChartApplet19 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine19());
     
   }  
}

class ChartLine19 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 500-160; // Center position of A
  ...
  private static int ycenterD = 500-240; // Center position of D
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("力威小学四年级女生参加各种兴趣小组活动情况统计图", 150, 60);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA, ycenterA, 40, 160);              
        }else{
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 240);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出4名学生参加气象组的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了气象组的柱状图，请继续画8名学生参加航模组的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了气象组、航模组的柱状图，请继续画9名学生参加音乐组的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了气象组、航模组、音乐组的柱状图，请继续画6名学生参加美术组的柱状图。你画了" + (clickCount+1) + "次";
                 }else{                    
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出四年级女生参加各种兴趣小组的柱状图。";
        comment2 = "即画出4人参加气象组、8人参加航模组、9人参加音乐组和6人参加美术组的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","气象组","","航模组","","音乐组","","美术组","","","兴趣小组"};
