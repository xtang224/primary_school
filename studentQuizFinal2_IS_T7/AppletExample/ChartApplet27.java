...
public class ChartApplet27 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine27());
     
   }  
}

class ChartLine27 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 500-280; // Center position of A
  ...
  private static int ycenterD = 500-200; // Center position of D
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("某校三年级同学最喜欢读的书的统计图", 150, 50);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 200);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出三年级35名同学喜欢童话书的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了三年级同学喜欢童话书的柱状图，请继续画30人喜欢故事书的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了三年级同学喜欢童话书、故事书的柱状图，请继续画30人喜欢漫画书的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了三年级同学喜欢童话书、故事书、漫画书的柱状图，请继续画25人喜欢连环画的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示画出三年级同学最喜欢读的书的统计图。";
        comment2 = "即画出35人喜欢童话书、30人喜欢故事书、30人喜欢漫画和25人喜欢连环画的条形统计图。"; 
     }
