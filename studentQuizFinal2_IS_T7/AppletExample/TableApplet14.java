...
public class TableApplet14 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table14Panel());
   }
}

class Table14Panel extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          Integer class1Value = (Integer)myTable.getValueAt(0,1);
          Integer class2Value = (Integer)myTable.getValueAt(0,2);
          Integer class3Value = (Integer)myTable.getValueAt(0,3);
          Integer class4Value = (Integer)myTable.getValueAt(0,4);
          Integer class5Value = (Integer)myTable.getValueAt(0,5);
          ...
          if (done){
             try{       
                connect();    
                target = "Table"+";"+class1Value+";"+class2Value+";"+class3Value+";"+class4Value+";"+class5Value;
                /*                    
                ptmt = dbCon.prepareStatement("select term2 from hintMatch where term1=?");
                ptmt.clearParameters();
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"月份", "1月", "2月", "3月", "4月", "5月"};
        private Object[][] data = {           
            {"数量/台", new Integer(-1), new Integer(-1), new Integer(-1), new Integer(-1), new Integer(-1)}
        };
