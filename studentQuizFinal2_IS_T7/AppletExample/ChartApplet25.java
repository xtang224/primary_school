...
public class ChartApplet25 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine25());
     
   }  
}

class ChartLine25 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int xcenterA = 140-40;
  private static int ycenterA = 500-240; // Center position of A
  private static int xcenterB = 220-40;
  private static int ycenterB = 500-80; // Center position of B
  private static int xcenterC = 300-40;
  private static int ycenterC = 500-160-13; // Center position of C  
  private static int xcenterD = 380-40;
  private static int ycenterD = 500-120; // Center position of D
  private static int xcenterE = 460;
  private static int ycenterE = 500-80; // Center position of E
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("四（3）班同学喜欢吃的水果统计图", 150, 200);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done2){
           g2d.fillRect(xcenterB, ycenterB, 40, 80);            
        }else{
        ...
        if (done3){
           g2d.fillRect(xcenterC, ycenterC, 40, 173);         
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出四（3）班13名同学喜欢苹果的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四（3）班同学喜欢苹果的柱状图，请继续画6人喜欢香蕉的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四（3）班同学喜欢苹果、香蕉的柱状图，请继续画13人喜欢菠萝的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了四（3）班同学喜欢苹果、香蕉、菠萝的柱状图，请继续画9人喜欢葡萄的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示画出四(3)班同学喜欢水果的统计图。";
        comment2 = "即画出18人喜欢苹果、6人喜欢香蕉、13人喜欢菠萝和9人喜欢葡萄的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"苹果","","香蕉","","菠萝","","葡萄",""};
  ...
  public void drawRuler2(Graphics2D g2d){
     ...
     for (int i=0; i<=60; i++){        
        if (i % 10 == 0){
           ...
           g2d.drawString(str, 100-50, 500-i*4);
        }
     }      
     gp.moveTo(100,500);
     gp.lineTo(100,220);
