...
public class ChartApplet28 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine28());
     
   }  
}

class ChartLine28 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterA = 500-120; // Center position of A
  private static int xcenterB = 220;
  private static int ycenterB = 500-320; // Center position of B
  private static int xcenterC = 300;
  private static int ycenterC = 500-280; // Center position of C  
  private static int xcenterD = 380;
  private static int ycenterD = 500-360; // Center position of D
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("某校四年级同学最喜欢读的书的统计图", 150, 50);  
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        if (done1){  
           g2d.fillRect(xcenterA, ycenterA, 40, 120);              
        }else{
        ...
        if (done3){
           g2d.fillRect(xcenterC, ycenterC, 40, 280);         
        }else{
        ...
        if (done4){
           g2d.fillRect(xcenterD, ycenterD, 40, 360);            
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请先画出四年级15名同学喜欢童话书的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了四年级同学喜欢童话书的柱状图，请继续画40人喜欢故事书的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了四年级同学喜欢童话书、故事书的柱状图，请继续画35人喜欢漫画书的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4==false){
                    comment = "你已经画出了四年级同学喜欢童话书、故事书、漫画书的柱状图，请继续画45人喜欢连环画的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示画出四年级同学最喜欢读的书的统计图。";
        comment2 = "即画出15人喜欢童话书、40人喜欢故事书、35人喜欢漫画和45人喜欢连环画的条形统计图。"; 
     }
  ...
  public void drawRuler(Graphics2D g2d){
     ...
     GeneralPath gp = new GeneralPath();
     String[] strs = new String[]{"","童","","故","","漫","","连",""};
     String[] strs2 = new String[]{"","话","","事","","画","","环",""};
     String[] strs3 = new String[]{"","书","","书","","书","","画",""};
     ...
     for (int i=0; i<=80; i++){        
        if (i % 10 == 0){
           ...
           g2d.drawString(strs3[intV], 100+i*4, 560);                     
        } 
     }
     gp.moveTo(100,500);
     gp.lineTo(500,500);
