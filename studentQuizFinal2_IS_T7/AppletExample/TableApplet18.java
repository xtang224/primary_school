...
public class TableApplet18 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table18Panel());
   }
}

class Table18Panel extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"", "四（1）班派出选手（填姓名）", "四（2）班", "获胜班级（填班级）"};
        private Object[][] data = {           
            {"第一场", "X", "斌斌", "X"},
            {"第二场", "X", "冬冬", "X"}, 
            {"第三场", "X", "雅雅", "X"} 
