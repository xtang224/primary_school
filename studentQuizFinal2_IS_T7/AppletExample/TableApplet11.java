...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"品名", "单价/元", "数量/盆", "总价/元"};
        private Object[][] data = {	    
            {"绿萝", new Integer(80), new Integer(25), new Integer(-1)},
	    {"白掌", new Integer(25), new Integer(-1), new Integer(750)},
            {"吊兰", new Integer(-1), new Integer(28), new Integer(560)}
        };
