...
public class TableApplet13 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table13Panel());
   }
}

class Table13Panel extends JPanel
...
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          ...
          //Integer class5Value = (String)myTable.getValueAt(2,2);
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"课外活动小组", "航模组", "乒乓球组", "书画组", "手工组"};
        private Object[][] data = {           
            {"人数", new Integer(-1), new Integer(-1), new Integer(-1), new Integer(-1)}
        };
