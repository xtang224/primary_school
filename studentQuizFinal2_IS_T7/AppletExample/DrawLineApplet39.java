...
public class DrawLineApplet39 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine39());
     
   }  
}

class DrawLine39 extends JPanel implements MouseListener, ActionListener
{
  ...
  public void drawArc(Graphics2D g2d){
     ...
     if (target.equals("给定底边高B"))  
        g2d.drawString("底", xcenterO-20, ycenterO+20); 
     else
        g2d.drawString("底", xcenterO-20, ycenterO-20); 
     ...
     if (clickCount>=0){
        ...
        if (done1){           
           ...
           if (inLine(xcenterD,ycenterD,xcenterC,ycenterC,startX,startY) && perpendicular(startX,startY,xcenterA,ycenterA,xcenterD,ycenterD,xcenterC,ycenterC)){
              done1 = true; 
              drawCorrect = true;              
              gp.moveTo(xcenterA,ycenterA);
              gp.lineTo(xcenterO,ycenterO);
