...
public class ChartApplet14 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new ChartLine14());
     
   }  
}

class ChartLine14 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterD = 340; // Center position of D
  ...
  public void paint(Graphics g)
  {
    ...
    g2d.drawString("小芳踢毽子成绩统计图", 150, 50);   
  }
  ...
  public void drawArc(Graphics2D g2d){
     ...
     */    
     ...
     if (clickCount>=0){        
        ...
        if (done3){
           g2d.fillRect(xcenterC, ycenterC, 40, 200);         
        }else{
     ...
     if (clickCount>=0){
        if (done1==false){  
           comment = "你还没有画对,请根据要求先画出小芳第一次踢毽子12下的柱状图,你画了" + (clickCount+1) + "次"; 
        }else{
           if (done2==false){
              comment = "你已经画出了小芳第一次踢毽子的柱状图，请继续画小芳第二次踢毽子16下的柱状图。你画了" + (clickCount+1) + "次";
           }else{
              if (done3==false){
                 comment = "你已经画出了小芳第一次、第二次踢毽子的柱状图，请继续画小芳第三次踢毽子10下的柱状图。你画了" + (clickCount+1) + "次";
              }else{
                 if (done4 == false){
                    comment = "你已经画出了小芳第一次、第二次、第三次踢毽子的柱状图，请继续画小芳第四次踢毽子8下的柱状图。你画了" + (clickCount+1) + "次";
                 }else{
                    drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：请按照提示先后画出小芳第一次、第二次、第三次和第四次踢毽子的柱状图。";
        comment2 = "即画出第一次踢毽子12下、第二次踢毽子16下、第三次踢毽子10下和第四次踢毽子8下的条形统计图。"; 
     }
