...
public class GenerateTest {
  ...
  private String subPath3;
  private String subPath4;
  private String subPath5; 
  ...
  private String[] sources = new String[]{"ch1_1","ch1_2","ch1_3","ch1_4","ch1_5","ch1_6","ch1_7","ch1_8","ch1_9","ch1_10","ch1_11","ch1","ch2_1","ch2","ch3_1","ch3_2","ch3_3","ch3_4","ch3_5","ch3","ch4_1","ch4_2","ch4_3","ch4_4","ch4_5","ch4_6","ch4","ch5_1", "ch5_2", "ch5_3", "ch5_4", "ch5_5", "ch5_6", "ch5_self", "ch5_hk", "ch5", "ch5_add", "ch6_1", "ch6_2", "ch6_3", "ch6_4", "ch6_5", "ch6_hk", "ch6_6", "ch6_7", "ch6_8", "ch6_9", "ch6_10", "ch6_self", "ch6_hk2", "ch6", "ch56", "ch6_hk3", "ch7", "ch8_1", "ch8_2", "ch8_3", "ch8_self", "ch8"};
  ...
  public static void main(String[] args) {
   ...
   public void initUsedSet(){
      filePath = TOMCAT_PATH + cNote + subPath1;
      hs_used = initSetFromPath(filePath + cNote + "Questions2_test_used.txt");
      hs_tf_used = initSetFromPath(filePath + cNote + "Choices2_test_used.txt");
      hs_fb_used = initSetFromPath(filePath + cNote + "FillBlank2_test_used.txt");
      hs_fdb_used = initSetFromPath(filePath + cNote + "FillDoubleBlanks2_test_used.txt");
      hs_m_used = initSetFromPath(filePath + cNote + "Multiply_test_used.txt");
      hs_d_used = initSetFromPath(filePath + cNote + "Division_test_used.txt");

      filePath = TOMCAT_PATH + cNote + subPath2;
      addSetFromPath(hs_used, filePath + cNote + "Questions2_test_used.txt");
      addSetFromPath(hs_tf_used, filePath + cNote + "Choices2_test_used.txt");
      addSetFromPath(hs_fb_used, filePath + cNote + "FillBlank2_test_used.txt");
      addSetFromPath(hs_fdb_used, filePath + cNote + "FillDoubleBlanks2_test_used.txt");
      addSetFromPath(hs_m_used, filePath + cNote + "Multiply_test_used.txt");
      addSetFromPath(hs_d_used, filePath + cNote + "Division_test_used.txt");

      filePath = TOMCAT_PATH + cNote + subPath3;
      addSetFromPath(hs_used, filePath + cNote + "Questions2_test_used.txt");
      addSetFromPath(hs_tf_used, filePath + cNote + "Choices2_test_used.txt");
      addSetFromPath(hs_fb_used, filePath + cNote + "FillBlank2_test_used.txt");
      addSetFromPath(hs_fdb_used, filePath + cNote + "FillDoubleBlanks2_test_used.txt");
      ...
      filePath = TOMCAT_PATH + cNote + subPath4;
      addSetFromPath(hs_used, filePath + cNote + "Questions2_test_used.txt");
      addSetFromPath(hs_tf_used, filePath + cNote + "Choices2_test_used.txt");
      addSetFromPath(hs_fb_used, filePath + cNote + "FillBlank2_test_used.txt");
      addSetFromPath(hs_fdb_used, filePath + cNote + "FillDoubleBlanks2_test_used.txt");
      ...
      filePath = TOMCAT_PATH + cNote + subPath5;
      addSetFromPath(hs_used, filePath + cNote + "Questions2_test_used.txt");
      addSetFromPath(hs_tf_used, filePath + cNote + "Choices2_test_used.txt");
      addSetFromPath(hs_fb_used, filePath + cNote + "FillBlank2_test_used.txt");
      addSetFromPath(hs_fdb_used, filePath + cNote + "FillDoubleBlanks2_test_used.txt");
   ...
   public void initSet(){
     try{
        ...
        //now we want to only get 10 choices for this generated test
        tmpSet = new HashSet();
        ...
        //now we want to only get 5 multiply questions for this generated test
        tmpSet = new HashSet();
        controlSet = new HashSet();
        obs = hs_m.toArray();
        for (int i=0; i<5; i++){
        ...
        //now we want to only get 5 division questions for this generated test
        tmpSet = new HashSet();
        controlSet = new HashSet();
        obs = hs_d.toArray();
        for (int i=0; i<5; i++){
   ...
   public void saveTestPaper(){
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote + "generated_test_paper_final_3p.txt";
      saveFile();
   }
...
/***********************************************************/
   ...
   private void addSetFromPath(HashSet hSet, String path){
      BufferedReader reader = null;
      InputStream inputStream = null;
      File file = new File(path);
      String[] strings;
      try {
         ...
         while ((line = reader.readLine()) != null) {
            ...
            strings = line.split(";");
            for (int i=0; i<strings.length; i++){
               hSet.add(new Integer(strings[i].trim()));
            }
         }
          reader.close();
      }catch (FileNotFoundException e){
