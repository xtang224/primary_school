...
public class GenerateTestCompare {
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIdsCompare(){
      filePath_pre = TOMCAT_PATH + cNote + subPath7 + cNote + "compare";
      result = "";
      Object[] obs = hs.toArray();
      Arrays.sort(obs);
      ...
      filePath = filePath_pre + cNote + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = filePath_pre + cNote + "Choices2_test_used.txt";
      saveFile();      
      ...
      filePath = filePath_pre + cNote + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = filePath_pre + cNote + "FillDoubleBlanks2_test_used.txt";
      saveFile();
   }
   ...
   public void saveTestIdsForAndroid(){
      filePath_pre = TOMCAT_PATH + cNote + subPath7 + cNote + comparePath + cNote + subAndroidPath;
      result = "";
      ...
      filePath = filePath_pre + cNote + "Questions2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = filePath_pre + cNote + "Choices2_test_usedForAndroid.txt";
      saveFile();     
      ...
      filePath = filePath_pre + cNote + "FillBlank2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = filePath_pre + cNote + "FillDoubleBlanks2_test_usedForAndroid.txt";
      saveFile();
   }
