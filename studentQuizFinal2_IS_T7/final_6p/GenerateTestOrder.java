...
public class GenerateTestOrder {
  ...
  private final String TEST_PATH = "E:\\Teaching\\test\\test\\pic";
  ...
  //private String subPath7 = "\\ch6_all6";
  //private String subPath7 = "ch8_all2";
  //private String subPath7 = "final_1p";
  //private String subPath7 = "final_2p";
  //private String subPath7 = "final_4p";
  //private String subPath7 = "final_5p";
  private String subPath7 = "final_6p";
  ...
  private HashSet mhs_str = new HashSet();//aTOMCAT_PATHctually not needed
  ...
  public static void main(String[] args) {
     GenerateTestOrder aTest = new GenerateTestOrder();
     aTest.init();
     aTest.initUsedSet();
     aTest.initSet();
     aTest.saveTestIds();
   ...
   public void initUsedSet(){
      ...
      mhs_used =  initSetFromPath(filePath + cNote + "MultipleQuestions2_test_used.txt");    
   }
   ...
   public void saveTestIds(){
      ...
      int[] intObs = new int[obs.length];
      for (int i=0; i<intObs.length; i++)
         intObs[i] = ((Integer)obs[i]).intValue();
      Arrays.sort(intObs);
      for (int i=0; i<intObs.length; i++){         
         result += intObs[i]+ ";";
      }
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote + "score" + cNote + "Questions2_test_used.txt";
      saveFile();

      result = "";
      obs = hs_tf.toArray();
      intObs = new int[obs.length];
      for (int i=0; i<intObs.length; i++)
         intObs[i] = ((Integer)obs[i]).intValue();
      Arrays.sort(intObs);
      for (int i=0; i<intObs.length; i++){         
      ...
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote + "score" + cNote  + "Choices2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote  + "score" + cNote + "Multiply_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote  + "score" + cNote + "MultipleQuestions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote  + "score" + cNote + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote  + "score" + cNote + "FillDoubleBlanks2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote  + "score" + cNote + "Division_test_used.txt";
      saveFile();
   }
   ...
   public void saveTestPaper(){
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote + "generated_test_paper_final_4p.txt";
      saveFile();
   }
