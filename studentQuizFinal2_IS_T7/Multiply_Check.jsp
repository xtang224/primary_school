  ...
  <body bgcolor="white"><p>   
   ...
   <html:errors/><p> 
    ...
    <% session = request.getSession(true);     
       ...
       session.setAttribute(hello.Constants.MULTIPLY_KEY, _mb);
       ...
       session.setAttribute(hello.Constants.HASHSET_MY_KEY, _hs_d);
    ...
    <logic:present name="multiplybean" scope="session">
       <h2>
         ...
         <bean:write name="multiplybean" property="p1Solution" /><br>
         <bean:write name="multiplybean" property="p2Solution" /><br>    
         <bean:write name="multiplybean" property="line2" /><br>
         <bean:write name="multiplybean" property="resultSolution" /><P> 
       </h2>
    </logic:present>
    <%= extraSolution%><br>
    ...
    <logic:present name="multiplybean" scope="session">
       <h2>         
         ...
         <bean:write name="multiplybean" property="factor2" /><br> 
         <bean:write name="multiplybean" property="line1" /><br>   
         <bean:write name="multiplybean" property="yourSolution_1st" /><br>
         <bean:write name="multiplybean" property="yourSolution_2nd" /><br>    
         <bean:write name="multiplybean" property="line2" /><br>
         <bean:write name="multiplybean" property="yourSolution_3rd" /><P> 
       </h2>
    </logic:present>
