...
public class GenerateTest {
  ...
  public static void main(String[] args) {
   ...
   public void initUsedSet(){
      ...
      HashSet tmpSet = initSetFromPath(filePath + "\\" + "Questions2_test_used.txt");
      hs_used.addAll(tmpSet);
      tmpSet = initSetFromPath(filePath + "\\" + "Choices2_test_used.txt");
      hs_tf_used.addAll(tmpSet);
      tmpSet = initSetFromPath(filePath + "\\" + "FillBlank2_test_used.txt");
      hs_fb_used.addAll(tmpSet);
      tmpSet = initSetFromPath(filePath + "\\" + "FillDoubleBlanks2_test_used.txt");
      hs_fdb_used.addAll(tmpSet);
      tmpSet = initSetFromPath(filePath + "\\" + "Multiply_test_used.txt");
      hs_m_used.addAll(tmpSet);
   }
   ...
   public void saveTestPaper(){
      filePath = TOMCAT_PATH + subPath3 + "\\" + "generated_test_paper.txt";
      saveFile();
   }
