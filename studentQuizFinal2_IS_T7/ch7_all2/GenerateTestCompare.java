...
public class GenerateTestCompare {
  ...
  private String subPath5 = "ch7_all2";
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIdsCompare(){
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + "compare" + cNote + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + "compare" + cNote + "Choices2_test_used.txt";
      saveFile();      
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + "compare" + cNote + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + "compare"  + cNote + "FillDoubleBlanks2_test_used.txt";
      saveFile();
   }
   ...
   public void saveTestIdsForAndroid(){
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + comparePath + cNote + subAndroidPath + cNote + "Questions2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + comparePath + cNote + subAndroidPath + cNote + "Choices2_test_usedForAndroid.txt";
      saveFile();     
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + comparePath + cNote + subAndroidPath + cNote + "FillBlank2_test_usedForAndroid.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + cNote + subPath5 + cNote + comparePath + cNote + subAndroidPath + cNote + "FillDoubleBlanks2_test_usedForAndroid.txt";
      saveFile();
   }
