...
public class GenerateTestDirect {
  ...
  private String subPath7 = "ch7_all2";
  ...
  public static void main(String[] args) {
         ...
         */
         ...
         for (int i=0; i<obs.length; i++){
            ...
            while(rs.next()){
               String tmpStr1 = rs.getString(1);     
               String tmpStr2 = rs.getString(2);                                          
               result += integer.intValue() + "." + tmpStr1 + "¡Â" + tmpStr2 + NEW_LINE;
               count ++;
            } 
         } 
      }catch (ClassNotFoundException ce) {
   ...
   public void saveTestPaper(){
      filePath = TOMCAT_PATH + cNote + subPath7 + cNote + "generated_test_paper_ch7_all2.txt";
      saveFile();
   }
