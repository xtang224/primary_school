...
public class GenerateTest {
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIds(){
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "Choices2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "Multiply_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "MultipleQuestions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath11 + "\\" + "Division_test_used.txt";
      saveFile();
   }
