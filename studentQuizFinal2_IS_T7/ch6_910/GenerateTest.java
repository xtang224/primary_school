...
public class GenerateTest {
  ...
  private String subPath7 = "\\ch6_910";
  ...
  private String[] sources = new String[]{"ch6_9", "ch6_10"}; 
  ...
  public static void main(String[] args) {
   ...
   public void saveTestIds(){
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "Questions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "Choices2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "Multiply_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "MultipleQuestions2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "FillBlank2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "FillDoubleBlanks2_test_used.txt";
      saveFile();
      ...
      filePath = TOMCAT_PATH + subPath7 + "\\" + "Division_test_used.txt";
      saveFile();
   }
