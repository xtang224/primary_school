...
public final class ClearAction extends Action {
    ...
    throws Exception {
        ...
        try {
           ...
           stmt = myConnection.prepareStatement("delete from usedQuestions2_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate();

           stmt = myConnection.prepareStatement("delete from usedChoices2_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate();

           stmt = myConnection.prepareStatement("delete from usedTermMatch_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate();

           stmt = myConnection.prepareStatement("delete from usedFillBlank2_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate();

           stmt = myConnection.prepareStatement("delete from usedFillDoubleBlanks2_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate();
           ...
           stmt = myConnection.prepareStatement("delete from usedMultiply_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate(); 

           stmt = myConnection.prepareStatement("delete from usedDivision_test where studentNo=? and source=?");
           stmt.clearParameters();
           stmt.setString(1, userName);  
           stmt.setString(2, source);  
           stmt.executeUpdate(); 
