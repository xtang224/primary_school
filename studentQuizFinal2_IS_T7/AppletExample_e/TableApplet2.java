...
public class TableApplet2 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table2Panel());
   }
}

class Table2Panel extends JPanel implements ActionListener
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          ...
          Integer truckValue = (Integer)myTable.getValueAt(1,3);
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"物品",
                                        "总价/元",
                                        "单价/元",
                                        "数量/个"};
        private Object[][] data = {
	    {"篮球", new Integer(-1), new Integer(89), new Integer(22)},
	    {"皮球", new Integer(780), new Integer(12), new Integer(-1)},
            {"网球", new Integer(960), new Integer(-1), new Integer(16)}	    
        };
