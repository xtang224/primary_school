...
public class TableApplet4 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table4Panel());
   }
}

class Table4Panel extends JPanel
...
{  
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"水果", "西瓜", "苹果", "桃子", "梨子"};
        private Object[][] data = {	    
            {"个数", new Integer(-1), new Integer(-1), new Integer(-1), new Integer(-1)}	    
        };
