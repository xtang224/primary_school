  ...
  public void drawArc(Graphics2D g2d){
     ...
     */
     ...
     if (clickCount>=0){
        ...
        if (target.equals("长方形A"))      
           comment = "你还没有开始画，请用鼠标点击画线：请按提示以点A为顶点，先画4厘米的长，再画2厘米的宽，完成这个长方形"; 
        else if (target.equals("长方形B"))
           comment = "你还没有开始画，请用鼠标点击画线：请按提示以点A为顶点，先画3厘米的长，再画2厘米的宽，完成这个长方形"; 
        else
           comment = "你还没有开始画，请用鼠标点击画线：请按提示以点A为顶点，先画3厘米的横边，再画3厘米的竖边，完成这个正方形"; 
     }
