...
public class TableApplet3 extends JApplet
{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new Table3Panel());
   }
}

class Table3Panel extends JPanel implements ActionListener
{  
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (command.equals(GETINPUT)) {
          Integer class1Value = (Integer)myTable.getValueAt(2,1);
          Integer class2Value = (Integer)myTable.getValueAt(2,2);
          Integer class3Value = (Integer)myTable.getValueAt(2,3);
          Integer class4Value = (Integer)myTable.getValueAt(2,4);
          ...
          if (done){
             try{       
                connect();    
                target = "Table"+";"+class1Value+";"+class2Value+";"+class3Value+";"+class4Value;
                /*                    
                ptmt = dbCon.prepareStatement("select term2 from hintMatch where term1=?");
                ptmt.clearParameters();
                ptmt.setString(1, "table"); 
    ...
    class MyTableModel extends AbstractTableModel {
        private String[] columnNames = {"班级", "四（1）", "四（2）", "四（3）", "四（4）"};
        private Object[][] data = {
	    {"捐款总数（元）", new Integer(630), new Integer(697), new Integer(675), new Integer(672)},
	    {"人数/人", new Integer(42), new Integer(41), new Integer(45), new Integer(48)},
            {"平均每人捐款数/元", new Integer(-1), new Integer(-1), new Integer(-1), new Integer(-1)}	    
        };
