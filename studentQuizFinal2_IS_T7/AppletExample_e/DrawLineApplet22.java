...
public class DrawLineApplet22 extends JApplet{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine22());     
   }  
}

class DrawLine22 extends JPanel implements MouseListener, ActionListener
{
     ...
     if (clickCount>=0){
        if (done1==false){  
           if (target.equals("长方形"))         
              ...
              comment = "你还没有画对,请根据已有的正方形的一条左侧边画出和点A在同一条边上的第三个顶点,你画了" + (clickCount+1) + "次;"; 
        }else{
           if (done2==false){
              comment = "你已经画出了第三个顶点，请继续画出第四个顶点,完成这个正方形。你画了" + (clickCount+1) + "次;";
           }else{
              drawCorrect = true;
        ...
        if (target.equals("长方形"))      
           ...
           comment = "你还没有开始画，请用鼠标点击画线：请根据已有的正方形的一条左侧边先画出和A同边的第三个顶点，再画第四个顶点，完成这个正方形"; 
     }
