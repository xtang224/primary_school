...
public class DrawLineApplet9 extends JApplet{  
   public void init()
   {  
      Container contentPane = getContentPane();
      contentPane.add(new DrawLine9());     
   }  
}

class DrawLine9 extends JPanel implements MouseListener, ActionListener
{
  ...
  private static int ycenterO = 200;
  ...
  DrawLine9()
  {
    ...
    if (target.equals("垂线A")){
       ...
       xcenterA = 700; ycenterA = 250;
       xcenterO = 592; ycenterO = 106;
     ...
     if (clickCount>=0){
        if (drawCorrect==false){
           if (perpendicular(startX, startY, xcenterA, ycenterA, xcenterB, ycenterB, xcenterC, ycenterC)){
              if ((target.equals("垂线B") || target.equals("垂线D") || target.equals("垂线E")) && inLine(xcenterB,ycenterB,xcenterC,ycenterC,startX,startY)){
                 drawCorrect = true;
        ...
        comment = "你还没有开始画，请用鼠标点击画线：画出过点A垂直于已知直线的垂线"; 
     }
